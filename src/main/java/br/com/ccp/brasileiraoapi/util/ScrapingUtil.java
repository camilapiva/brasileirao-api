...
public class ScrapingUtil {
	...
	public static void main(String[] args) {
		String url = BASE_URL_GOOGLE + "philadelphia+union+x+new+york+city+26/06/2022" + COMPLEMENTO_URL_GOOGLE;
	...
	public PartidaGoogleDTO obtendoInformacoesPartida(String url) {
		...
		try {
			...
			String tempoPartida = obtendoTempoPartida(document); 
	...
	public StatusPartida obtendoStatusPartida(Document document) {
		//Situações: 1- Partida não iniciada, 2- Partida iniciada, 3- Partida encerrada, 4- Penalidades
	...
	public String obtendoTempoPartida(Document document) {
		String tempoPartida = null;
		
		//Jogo em andamento, intervalo ou penalidades
		boolean isTempoPartida = document.select("div[class=imso_mh__lv-m-stts-cont]").isEmpty();
		if(!isTempoPartida) {
